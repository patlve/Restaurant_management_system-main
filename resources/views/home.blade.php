...
<html lang="en">
  ...
  <head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('assets/images/short.png') }}">
    <link href="https://fonts.googleapis.com/css?family=Poppins:100,200,300,400,500,600,700,800,900&display=swap" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Dancing+Script:wght@400;500;600;700&display=swap" rel="stylesheet">

    <title>PATRA Restaurant</title>
<!--
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="{{url('home')}}"href="#top" class="logo">
                            <img src="{{ asset('assets/images/klassy-logo.p')}}" align="klassy cafe html template">
                        </a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="left-text-content">
                        ...
                        <p>PATRA Cafe is one of the best restaurant HTML templates</a> with Bootstrap v4.5.2 CSS framework. You can download and feel free to use this website template layout for your restaurant business. You are allowed to use this template for commercial purposes. <br><br>You are NOT allowed to redistribute the template ZIP file on any template donwnload website. Please contact us for more information.</p>
                        <div class="row">
                            <div class="col-4">
                ...
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="right-content">
                        <div class="thumb">
                            <a rel="nofollow" href="https://www.youtube.com"><i class="fa fa-play"></i></a>
                ...
                <div class="owl-menu-item owl-carousel">
                    <div class="item">
                        <div class='card card1'>
                            <div class="price"><h6>frs 14</h6></div>
                            <div class='info'>
                              <h1 class='title'>Chocolate Cake</h1>
                              <p class='description'>patra welcomes you </p>
                    ...
                    <div class="item">
                        <div class='card card2'>
                            <div class="price"><h6>frs 22</h6></div>
                            <div class='info'>
                              <h1 class='title'>Patra Pancake</h1>
                              <p class='description'>patra welcomes you </p>
                              <div class="main-text-button">
                                  <div class="scroll-to-section"><a href="#reservation">Make Reservation <i class="fa fa-angle-down"></i></a></div>
                              </div>
                    ...
                    <div class="item">
                        <div class='card card3'>
                            <div class="price"><h6>frs 18</h6></div>
                            <div class='info'>
                              <h1 class='title'>Tall Patra Bread</h1>
                              <p class='description'>patra welcomes you </p>
                              <div class="main-text-button">
                                  <div class="scroll-to-section"><a href="#reservation">Make Reservation <i class="fa fa-angle-down"></i></a></div>
                              </div>
                    ...
                    <div class="item">
                        <div class='card card4'>
                            <div class="price"><h6>frs 10</h6></div>
                            <div class='info'>
                    ...
                    <div class="item">
                        <div class='card card5'>
                            <div class="price"><h6>frs 8.50</h6></div>
                            <div class='info'>
                              <h1 class='title'>Patra Cup Cake</h1>
                              <p class='description'>patra welcomes you </p>
                              <div class="main-text-button">
                                  <div class="scroll-to-section"><a href="#reservation">Make Reservation <i class="fa fa-angle-down"></i></a></div>
                              </div>
                    ...
                    <div class="item">
                        <div class='card card3'>
                            <div class="price"><h6>frs 7.25</h6></div>
                            <div class='info'>
                              <h1 class='title'>Patra Cake</h1>
                              <p class='description'>patra welcomes you </p>
                              <div class="main-text-button">
                                  <div class="scroll-to-section"><a href="#reservation">Make Reservation <i class="fa fa-angle-down"></i></a></div>
                              </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="phone">
                                    ...
                                    <h4>Phone Numbers</h4>
                                    <span><a href="#">237 6 95 88 48 80</a><br><a href="#">6 98 35 71 21</a></span>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="message">
                                    ...
                                    <h4>Emails</h4>
                                    <span><a href="#">patriciabidjeck.com</a><br><a href="#">lookingfor.com</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
